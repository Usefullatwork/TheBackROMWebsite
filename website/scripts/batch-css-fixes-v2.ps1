# Batch CSS Fixes V2 - Extended to all plager subfolders
$websiteRoot = $PSScriptRoot | Split-Path -Parent

# Get ALL HTML files from all plager subfolders
$allFiles = @()
...
foreach ($file in $allFiles) {
    ...
    try {
        ...
        # Fix 3-5: Stat-number font sizes
